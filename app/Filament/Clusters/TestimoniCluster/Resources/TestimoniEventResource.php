...
use App\Filament\Clusters\TestimoniCluster\Resources\TestimoniEventResource\Pages;
use App\Filament\Clusters\TestimoniCluster\Resources\TestimoniEventResource\RelationManagers;

class TestimoniEventResource extends Resource
{
    protected static ?string $model = TestimoniEvent::class;

    protected static ?string $navigationIcon = 'heroicon-s-calendar-days';

    protected static ?string $navigationLabel = 'Testimoni Event';
    protected static ?string $slug = 'testimoni-event';
            ...
            ->schema([
                Infolists\Components\Section::make('Informasi Testimoni')
                    ->schema([
                        ...
                        Infolists\Components\TextEntry::make('event.nama_event')
                            ->label('Event')
                            ->icon('heroicon-o-calendar-days'),

                        Infolists\Components\TextEntry::make('event.kategori_event.nama_kategori_event')
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\SelectColumn::make('status')
                    ...
                    ->disabled(fn() => !auth()->user()->can('update_testimoni::event', TestimoniEvent::class))
                    ->rules(['required']),
    ...
    {
        return [
            'index' => Pages\ListTestimoniEvent::route('/'),
            'view' => Pages\ViewTestimoniEvent::route('/{record}'),
            'edit' => Pages\EditTestimoniEvent::route('/{record}/edit'),
        ];
    }
    public static function canAccess(): bool
    {
        return auth()->user()?->can('view_any_testimoni::event') ?? false;
    }
