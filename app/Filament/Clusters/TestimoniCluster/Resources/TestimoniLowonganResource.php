...
use App\Filament\Clusters\TestimoniCluster\Resources\TestimoniLowonganResource\Pages;
use App\Filament\Clusters\TestimoniCluster\Resources\TestimoniLowonganResource\RelationManagers;

class TestimoniLowonganResource extends Resource
{
    protected static ?string $model = TestimoniLowongan::class;

    protected static ?string $navigationIcon = 'heroicon-s-briefcase';

    protected static ?string $navigationLabel = 'Testimoni Lowongan';
    protected static ?string $slug = 'testimoni-lowongan';
            ...
            ->schema([
                Infolists\Components\Section::make('Informasi Testimoni')
                    ->schema([
                        ...
                        Infolists\Components\TextEntry::make('lowongan.kategori_lowongan.nama_kategori_lowongan')
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\SelectColumn::make('status')
                    ...
                    ->disabled(fn() => !auth()->user()->can('update_testimoni::lowongan', TestimoniLowongan::class))
                    ->rules(['required']),
    ...
    {
        return [
            'index' => Pages\ListTestimoniLowongan::route('/'),
            'view' => Pages\ViewTestimoniLowongan::route('/{record}'),
            'edit' => Pages\EditTestimoniLowongan::route('/{record}/edit'),
        ];
    }
    public static function canAccess(): bool
    {
        return auth()->user()?->can('view_any_testimoni::lowongan') ?? false;
    }
